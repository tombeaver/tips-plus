  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table: "w-full border-collapse max-w-none",
        head_row: "flex mb-1",
        head_cell: "text-muted-foreground rounded-md flex-1 min-w-0 h-6 font-medium text-xs flex items-center justify-center",
        row: "flex w-full mb-1",
        cell: "relative flex-1 min-w-0",
        day: cn(
